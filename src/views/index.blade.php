                                            ...
                                            @if($mod->game == $server->egg_id)
                                                <tr>
                                                    ...
                                                    <td class="middle text-center col-xs-2">
                                                        <form action="{{ action('Server\ModController@install', [ $server->uuidShort, $mod ]) }}" id="function-install{{$mod->id}}" method="POST">
                                                            @csrf
                                                            @method('POST')
                                                    ...
                                                    <td class="middle text-center col-xs-2">
                                                        <form action="{{ action('Server\ModController@remove', [ $server->uuidShort, $mod ]) }}" id="function-delete{{$mod->id}}" method="POST">
                                                            @csrf
                                                            @method('POST')
